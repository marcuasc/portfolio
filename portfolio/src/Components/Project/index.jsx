...
const Project = (props) => {
  return (
        ...
        <div className=" flex flex-col w-1/2 h-96 rounded-l-lg border-indigo-100 p-8 bg-white" >
        <div className="uppercase tracking-wide text-2xl text-black ">{props.title}</div>
        <p className =" font-semibold mt-5 " > {props.description} </p>
        <br/>
        <motion.button whileHover={{ scale: 1 }} whileTap={{ scale: 0.9 }} className="bg-blue-400 border-black  hover:bg-blue-700 text-white font-bold font-mo py-2 px-4 rounded-lg w-2/3 m">
          View Project
        </motion.button>
        </div>
