...
const Projects = () => {
  return (
    ...
    <div className="flex-row bg-blueGray min-h-screen w-screen transform rotate-rq-8 block p-7">
      ...
      <div className="flex flex-col w-1/3 h-8 m-auto justify-center justify bg-red-300 p-8 text-3xl" >
        <h1>Prosjekter</h1>
        </div>

        <div className=" flex flex-row w-3/5 h-96 rounded-lg bg-gradient-to-r from-green-400 to-blue-500 m-auto mb-5 mt-60 shadow-2xl" >
