...
const FrontPage = () => {
  ...
  <div className="w-3/4 h-3/4  m-20 mt-20 ml-40  rounded-xl p-6 font-sans text-4xl text-midnightG  z-10 absolute" >
...
/>
  ...
  <p className=" text-lg w-2/4 mt-7" > 
  ...
  Ut quis sagittis mi, et auctor mauris. Nunc quis leo dapibus, euismod risus bibendum, consequat ex. Nullam commodo ipsum eu purus cursus egestas. Vivamus ipsum dui, malesuada sit amet urna id, imperdiet malesuada ante.
    ...
    <motion.img src={Portrait} alt="portrait" className=" w-2/6  mt-3.5 left-1/2  absolute opacity-60"
    initial={{opacity:0}}
    animate={{opacity:0.6}}
